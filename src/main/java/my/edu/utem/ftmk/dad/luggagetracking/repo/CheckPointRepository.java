...
public interface CheckPointRepository extends JpaRepository<CheckPoint, Long>{
	...
	@Query("SELECT cp FROM CheckPoint cp WHERE cp.flight.flightNo = :flightNo AND cp.checkPointType.id = :checkPoinTypetId")
	CheckPoint findByFlightNoAndcheckPoinTypetId(@Param("flightNo") String flightNo, @Param("checkPoinTypetId") long checkPoinTypetId);
